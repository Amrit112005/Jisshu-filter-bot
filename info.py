...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Rout:Rout@cluster0.y7syq.mongodb.net/?retryWrites=true&w=majority")
...
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002222134137')) # The movie you upload in it will be deleted from the bot.
...
request_channel = environ.get('REQUEST_CHANNEL', '-1001915001261') # If anyone sends a request message to your bot, you will get it in this channel.
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002085669974')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+CXcRuQ4zPgM4ZGRl') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
